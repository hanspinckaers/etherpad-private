...
function OUTER(gscope) {
    ...
    function handleKeyEvent(evt) {
        ...
        var isModKey = ((!charCode) && ((type == "keyup") || (type == "keydown")) && (keyCode == 37 || keyCode == 39 || keyCode == 38 || keyCode == 40 || keyCode == 16 || keyCode == 17 || keyCode == 18 || keyCode == 20 || keyCode == 224 || keyCode == 91));
        if (isModKey) return;
    ...
    function setup() {
        ...
        inCallStack("setup", function () {
            ...
            if (browser.msie) {
                ...
                } catch (e) { /* throws an error in some IE 6 but not others! */
                }
            }
