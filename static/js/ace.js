...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '../static/nicEditorIcons.gif',
...
etherNicEditor = nicEditor.extend({
	...
	setup : function()
	{
		...
		var rep = {
  		...
  		this.attribPool = new AttribPool();
  		 
		console.log("attribPool");

		var _this = this;
  		this.changesetTracker = makeChangesetTracker(null, this.apool, {
			withCallbacks: function(operationName, f)
			{
				...
				f({
				      ...
				      applyChangesetToDocument: function(changeset, preferInsertionAfterCaret)
				      {
				        ...
				        console.log(changeset + preferInsertionAfterCaret)
	...
	setDocAText : function (atext) {
	    ...
	    if (rep.alltext != atext.text)
	    {
	      	...
	      	console.log("mismatch error setting raw text in setDocAText");
	    }
	},

	importAText : function(newCode, apoolJsonObj, undoable)
 	{
 		console.log("importAText");
 	...
 	getDebugProperty : function(prop)
  	{
  		console.log("getDebugProperty");
    	//return info.ace_getDebugProperty(prop);
  	},

 	setBaseText : function(txt)
  	{
  		console.log("setBaseText");
    	//info.ace_setBaseText(txt);
  	},
 	
 	setBaseAttributedText : function(atxt, apoolJsonObj)
  	{
  		console.log("setBaseAttributedText");
  		console.log(atxt);
 	...
 	applyChangesToBase : function(changes, optAuthor, apoolJsonObj)
  	{
  		console.log("applyChangesToBase");
    	// info.ace_applyChangesToBase(changes, optAuthor, apoolJsonObj);
  	},

  	setUserChangeNotificationCallback : function(callback)
  	{
  		console.log("setUserChangeNotificationCallback");
    	// info.ace_setUserChangeNotificationCallback(callback);
  	},

  	setAuthorInfo : function(author, authorInfo)
  	{
  		console.log("setAuthorInfo");
    	// info.ace_setAuthorInfo(author, authorInfo);
  	},
  
  	setAuthorSelectionRange : function(author, start, end)
  	{
  		console.log("setAuthorSelectionRange");
    	// info.ace_setAuthorSelectionRange(author, start, end);
  	},

  	getUnhandledErrors : function()
  	{
  		console.log("getUnhandledErrors");
    	//if (!loaded) return [];
    	// returns array of {error: <browser Error object>, time: +new Date()}
    	// return info.ace_getUnhandledErrors();
  	},

  	callWithAce : function(fn, callStack, normalize)
  	{
  		console.log("callWithAce");
    	//return info.ace_callWithAce(fn, callStack, normalize);
  	},

  	execCommand : function(cmd, arg1)
  	{
